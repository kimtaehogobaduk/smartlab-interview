...
/**
 * Constant-time comparison helper to prevent timing side-channel attacks when
 * comparing secret authorization tokens/passwords.
 */
export function safeCompare(a: string, b: string): boolean {
  ...
  // If lengths differ, compare bufA against itself to preserve constant execution time.
